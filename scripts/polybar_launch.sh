#!/usr/bin/env zsh
function _polybar_monitor_display_screen_all(){
...
function _polybar_monitor_display_screen_only(){
...
function _polybar_monitor_display_screen_only_alternative(){
    MONITOR=$m polybar --reload polybar-bottom &
}

function _polybar_render(){
